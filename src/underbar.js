...
(function() {
  ...
  _.zip = function() {
    var args = _.sortBy(Array.prototype.slice.call(arguments, 0), function(element){
      return -1 * element.length;
    });
    return args[0].map(function(element, index, array){
      return args.map(function(e, i, a){
        return e[index];
      });
    });
